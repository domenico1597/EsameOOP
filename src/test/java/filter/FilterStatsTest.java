...
/** Questa classe contiene il test della classe FilterStats, verificando il corretto
...
public class FilterStatsTest {
    ...
    */
    ...
    void WrongComparisonExceptionTest1() {
        ...
        filter = new FilterStats("stati", countryelements, "Genre", genreelements);
    ...
    void WrongComparisonExceptionTest2() {
        ...
        filter = new FilterStats("Country", countryelements, "genere", genreelements);
