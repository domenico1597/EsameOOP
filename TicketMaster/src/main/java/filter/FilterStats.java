...
/** Questa classe contiene i metodi necessari al filtraggio per la rotta "/stats".
 * 
...
public class FilterStats {
	...
	public FilterStats(String CountryComparison, Vector<String> CountryElements, String GenreComparison, Vector<String> GenreElements) {
	 ...
	 */
	 ...
	 public JSONArray getFilter() throws WrongComparisonException, WrongGenreException, WrongCountryException {
		...
		if (GenreComparison.equals("All")) {
			...
			array = filter.StatsEventsCountry(CountryElements);
		}
		...
		if(GenreComparison.equals("Genre")) {
			...
			array2 = filter.StatsEventsGenre(CountryElements, iterator.next());
